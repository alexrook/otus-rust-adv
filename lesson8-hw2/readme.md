...
использовать умные указатели и коллекции;
реализовать ввод/вывод с помощью стандартной библиотеки.
Краткое содержание
...
Сергей Потамошнев
Дата и время
26 марта, среда в 20:00
Длительность занятия: 90 минут
Опрос
Пожалуйста, пройдите опрос о занятии
Материалы
OTUS Rust Стандартная библиотека.pdf
Скачать
Вебинар
Домашнее задание
